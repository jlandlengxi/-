...
VerifyBtn.MouseButton1Click:Connect(function()
    ...
    if key == "lxnb" then
        ...
        pcall(function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/aaaaaaajwjnwj/-/refs/heads/main/%E6%AF%94%E7%8E%87.lua"))()
        end)
